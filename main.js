...
function test() {
    ...
    document.getElementsByClassName("pagination")[0].innerHTML = '<h1>PikiDiary+ beta 0.1.5 early access</h1> <input id="idea" type="checkbox">post ideas</input> <p>made with love by nomaakip <3</p>';
